...
+ (void) initialize
{
    ...
    [prefs registerDefaultObject: QUAKE_PREFS_VALUE_OPTION_KEY forKey: QUAKE_PREFS_KEY_SW_OPTION_KEY];
    [prefs registerDefaultObject: QUAKE_PREFS_VALUE_DISPLAY forKey: QUAKE_PREFS_KEY_SW_DISPLAY];
    [prefs registerDefaultObject: QUAKE_PREFS_VALUE_FADE_ALL forKey: QUAKE_PREFS_KEY_SW_FADE_ALL];
    ...
    [prefs registerDefaultObject: QUAKE_PREFS_VALUE_GL_OPTION_KEY forKey: QUAKE_PREFS_KEY_GL_OPTION_KEY];
}
...
- (void) initGame: (NSNotification*) notification
{
...
#else
    parameters.memsize = 8 * 1024 * 1024 * 2;
#endif /* GLQUAKE */
    ...
    const char divider[39] = {  0x80, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81,
                                0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81,
                                0x81, 0x81, 0x81, 0x81, 0x81, 0x82, 0x00 };
