...
void SCR_ScreenShot_f(void)
{
    ...
    glPixelStorei(GL_PACK_ALIGNMENT,
                  1); // buffer is sized tightly-packed; GL's default 4-byte row alignment would overrun it
...
void SCR_UpdateScreen(void)
{
    ...
    else if (CL_Intermission() == 1 && key_dest == keydest_t::key_game)
    {
        Sbar_IntermissionOverlay();
    }
    else if (CL_Intermission() == 2 && key_dest == keydest_t::key_game)
    {
        Sbar_FinaleOverlay();
