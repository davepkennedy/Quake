...
static const char warp_vert_src[] = "#version 450 core\n"
...
static const char warp_frag_src[] = "#version 450 core\n"
                                    "in vec2 v_uv;\n"
...
void EmitWaterPolys(msurface_t *fa)
{
    ...
    for (p = fa->polys; p; p = p->next)
    {
        ...
        int nverts = ntri * 3;
        qglBufferData(GL_ARRAY_BUFFER, (GLsizeiptr)(nverts * 5 * sizeof(float)), warp_stream, GL_STREAM_DRAW);
